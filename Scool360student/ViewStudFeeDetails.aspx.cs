...
namespace Scool360student
{
    public partial class ViewStudFeeDetails : System.Web.UI.Page
    {
        ...
        private void LoadAdvanceToGrid()
        {
            ...
            string sql;
            sql = "select  tblstudentfeeadvance.FeeName, tblstudentfeeadvance.PeriodName, tblbatch.BatchName, tblstudentfeeadvance.Amount from tblstudentfeeadvance inner join  tblbatch on tblstudentfeeadvance.BatchId= tblbatch.Id where tblstudentfeeadvance.StudentId=" + studentID + " ORDER BY tblbatch.Id";
            ...
            if (MydataSet != null && MydataSet.Tables != null && MydataSet.Tables[0].Rows.Count > 0)
            {
                ...
                Label_AdvNote.Text = "";
                Lbl_TotalAdvance.Text = GetTotalAdvance(studentID);
        ...
        protected void Btn_exporttoAdvexel_Click(object sender, ImageClickEventArgs e)
        {
            int studentID = int.Parse(MyUser.StudId.ToString());
            string sql;
            sql = "select  tblstudentfeeadvance.FeeName, tblstudentfeeadvance.PeriodName, tblbatch.BatchName , tblstudentfeeadvance.Amount from tblstudentfeeadvance inner join  tblbatch on tblstudentfeeadvance.BatchId= tblbatch.Id where tblstudentfeeadvance.StudentId=" + studentID;
            MydataSet = MyStudMang.m_MysqlDb.ExecuteQueryReturnDataSet(sql);
            if (MydataSet != null && MydataSet.Tables != null && MydataSet.Tables[0].Rows.Count > 0)
            {

                string FileName = "AdvanceList";
                string _ReportName = "<table><tr><td><b>Advance List</b></td></tr><tr><td>Student Name :" + MyUser.getStudName(studentID) + "</td><td>Date : " + DateTime.Now.ToString() + "</td></tr></table>";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (MydataSet != null && MydataSet.Tables != null && MydataSet.Tables[0].Rows.Count > 0)
            {
                ...
                string _ReportName = "<table><tr><td><b>Fee Due List</b></td></tr><tr><td>Student Name :" + MyUser.getStudName(studentID) + "</td><td>Date : " + DateTime.Now.ToString() + "</td></tr></table>";
           ...
           // string _BatchName = Grd_TransactionsAll.SelectedRow.Cells[2].Text.Trim();
            ...
            if (_BillId != "")
            {
                ...
                if (MyFeeMang.GetBillType(ref _Value, ref _PageName, out Pdf))
                {
                    ...
                    {
                        string _ErrorMsg = "";
                        Scool360student.Pdf MyPdf = new Pdf(MyFeeMang.m_MysqlDb, objSchool);
                        _ErrorMsg = "";
        ...
        protected void ImgExportAll_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string _ReportName = "<table><tr><td><b>Fee Transaction Report</b></td></tr><tr><td>Student Name :" + MyUser.getStudName(studentID) + "</td><td>Date : " + DateTime.Now.ToString() + "</td></tr></table>";
        ...
        //    string _Studstrip = MyStudMang.ToStripString(int.Parse(studentID), "Handler/ImageReturnHandler.ashx?id=" + int.Parse(studentID) + "&type=StudentImage", int.Parse(Session["StudType"].ToString()));
