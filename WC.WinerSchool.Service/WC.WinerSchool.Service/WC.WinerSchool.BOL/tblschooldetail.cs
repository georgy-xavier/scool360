...
namespace WC.WinerSchool.BOL
{
    ...
    public partial class tblschooldetail: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public string SchoolImage
        {
            ...
            set
            {
                if (_schoolImage != value)
                {
                    _schoolImage = value;
                    OnPropertyChanged("SchoolImage");
                }
            }
        }
        ...
        [DataMember]
        public byte[] SchoolImages
        {
            get { return _schoolImages; }
            set
            {
                if (_schoolImages != value)
                {
                    _schoolImages = value;
                    OnPropertyChanged("SchoolImages");
                }
            }
        }
        private byte[] _schoolImages;
