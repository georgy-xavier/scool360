...
namespace WC.WinerSchool.BOL
{
    ...
    public partial class tblbillcancel: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private Nullable<sbyte> _feeType;
        ...
        [DataMember]
        public Nullable<int> CanceledBy
        {
            get { return _canceledBy; }
            set
            {
                if (_canceledBy != value)
                {
                    _canceledBy = value;
                    OnPropertyChanged("CanceledBy");
                }
            }
        }
        private Nullable<int> _canceledBy;
