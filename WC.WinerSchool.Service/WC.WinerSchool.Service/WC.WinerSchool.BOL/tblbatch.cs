...
namespace WC.WinerSchool.BOL
{
    ...
    public partial class tblbatch: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public Nullable<int> NOfWorkingDays
        {
            get { return _nOfWorkingDays; }
            set
            {
                if (_nOfWorkingDays != value)
                {
                    _nOfWorkingDays = value;
                    OnPropertyChanged("NOfWorkingDays");
                }
            }
        }
        private Nullable<int> _nOfWorkingDays;
