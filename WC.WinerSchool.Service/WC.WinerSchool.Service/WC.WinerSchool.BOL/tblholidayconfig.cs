...
namespace WC.WinerSchool.BOL
{
    ...
    public partial class tblholidayconfig: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public sbyte StaffStatus
        {
            get { return _staffStatus; }
            set
            {
                if (_staffStatus != value)
                {
                    _staffStatus = value;
                    OnPropertyChanged("StaffStatus");
                }
            }
        }
        private sbyte _staffStatus;
