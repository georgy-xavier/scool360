...
namespace WC.WinerSchool.BOL
{
    ...
    public partial class tbl_generaltemplateseperatormap: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public Nullable<int> SeperatorId
        {
            get { return _seperatorId; }
            set
            {
                if (_seperatorId != value)
                {
                    _seperatorId = value;
                    OnPropertyChanged("SeperatorId");
                }
            }
        }
        private Nullable<int> _seperatorId;
