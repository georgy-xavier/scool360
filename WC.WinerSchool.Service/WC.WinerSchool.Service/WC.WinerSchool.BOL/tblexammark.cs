...
namespace WC.WinerSchool.BOL
{
    ...
    public partial class tblexammark: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public string MarkColumn
        {
            get { return _markColumn; }
            set
            {
                if (_markColumn != value)
                {
                    _markColumn = value;
                    OnPropertyChanged("MarkColumn");
                }
            }
        }
        private string _markColumn;
        ...
        private Nullable<System.DateTime> _examDate;
    
        [DataMember]
        public Nullable<int> TimeSlotId
        {
        ...
        private Nullable<int> _timeSlotId;
