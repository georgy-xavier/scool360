...
namespace WC.WinerSchool.BOL
{
    ...
    public partial class tbltime_submaster: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public System.DateTime Day
        {
            ...
            set
            {
                if (_day != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'Day' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _day = value;
