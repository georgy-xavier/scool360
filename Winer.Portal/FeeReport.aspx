            ...
            <asp:Panel ID="Pnl_InitialDetails" runat="server" HorizontalAlign="Left">
                 <div>
                     ...
                     <div class="col-lg-11" align="right">
                        <div class="form-group">
                            <asp:Button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored" id="Btn_Show" runat="server" Text="Show" OnClick="Btn_Show_Click">
                          
                            </asp:Button>

                            <%--<asp:Button class="btn btn-primary" ID="Btn_Show" runat="server" Text="Show"  
	                    ...
	                    <tbody id="tbody-grid">
                          ...
                          <div class="col-lg-12">
                            <div class="col-lg-3 col-lg-offset-4">
                                <input id="loadmoreschool" type="button"  class="btn btn-lg btn-default btn-block"  value="Load More" style="visibility: hidden;" />
                                  <%--<input id="loadmoreschool" type="button"   class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--accent" value="+" />--%>
                                <img src="img/Loading_icon.gif" alt="" id="loader" style="visibility: visible;"/>
                            </div>  
                             
                        </div>    
                         <%-- <input id="load-more-school" type="button" class="btn btn-primary btn-lg"  value="Load more" />--%>
