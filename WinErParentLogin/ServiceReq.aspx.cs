...
namespace WinErParentLogin
{
    public partial class ServiceReq : System.Web.UI.Page
    {
        ...
        private   const int  SERVICE_TYPE=1;
        ...
        private void loadrequestType()
        {
            ...
            {
                drp_servicetype.Items.Add(new ListItem("school does not allow to submit request","0"));
        ...
        protected void btnsendnewmessage_Click(object sender, EventArgs e)
        {
            ...
            int fromUserId = MyParentInfo.StudentId;
             ...
             _DblogObj.LogToDb(MyParentInfo.ParentName, "ParentLogin_Request", " Creaetd new request ," + serviceDescription + "", 2, 2);
             _DblogObj = null;
            _mysqlObj.CloseConnection();
