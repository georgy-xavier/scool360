...
{
    public partial class ServiceFeedBack : System.Web.UI.Page
    {
        ...
        private   const int  SERVICE_TYPE=3;
        ...
        private void loadrequestType()
        {
            ...
            {
                drp_servicetype.Items.Add(new ListItem("school does not allow to submit feedback","0"));
        ...
        protected void btnsendnewmessage_Click(object sender, EventArgs e)
        {
            ...
            int fromUserId = MyParentInfo.StudentId;
             ...
             _DblogObj.LogToDb(MyParentInfo.ParentName, "ParentLogin_FeedBack", " Creaetd new feedback ," + serviceDescription + "", 2, 2);
             _DblogObj = null;
            _mysqlObj.CloseConnection();
