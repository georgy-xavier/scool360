<%@ Page Title="" Language="C#" MasterPageFile="~/parentmaster.Master" AutoEventWireup="true" CodeBehind="ServiceReq.aspx.cs" Inherits="WinErParentLogin.ServiceReq" %>
...
<asp:Panel Width="100%" runat="server" ID="pnlMain" >
     ...
     Message: <asp:TextBox ID="txt_message" TextMode="MultiLine" MaxLength="500" Height="80px" class="form-control" Width="400px" runat="server" ></asp:TextBox>
...
<asp:Panel Width="100%" runat="server" ID="Panel1" >
     ...
     <td align="left" valign="middle" >
     Subject : 
         <asp:DropDownList ID="drp_servicetype" runat="server" class="form-control" Width="350px">
         </asp:DropDownList>
     </td>
     </tr>
     <tr>
     ...
     Message: <asp:TextBox ID="txtnewmessage" TextMode="MultiLine" MaxLength="700" Height="100px" class="form-control" Width="350px" runat="server" ></asp:TextBox>
