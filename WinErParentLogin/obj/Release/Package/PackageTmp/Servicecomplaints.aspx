<%@ Page Title="" Language="C#" MasterPageFile="~/parentmaster.Master" AutoEventWireup="true" CodeBehind="Servicecomplaints.aspx.cs" Inherits="WinErParentLogin.Servicecomplaints" %>
...
<asp:Panel Width="100%" runat="server" ID="pnlMain" >
     ...
     Subject : <asp:TextBox ID="txt_subj" runat="server" MaxLength="250" class="form-control" Width="400px"></asp:TextBox>
     ...
     Message: <asp:TextBox ID="txt_message" TextMode="MultiLine" MaxLength="500" class="form-control" Height="80px" Width="400px" runat="server" ></asp:TextBox>
     ...
     <tr>
     <td  align="center"  >
        <asp:Button ID="btn_msg" runat="server"  Text="Send" class="btn btn-primary" ValidationGroup="ValidSend" 
...
<asp:Panel Width="100%" runat="server" ID="Panel1" >
     ...
     Message: <asp:TextBox ID="txtnewmessage" TextMode="MultiLine" MaxLength="700" Height="100px" Width="350px" class="form-control" runat="server" ></asp:TextBox>
