<%@ Page Language="C#" MasterPageFile="~/WinerSchoolMaster.Master" AutoEventWireup="true" CodeBehind="BookIssueReport.aspx.cs" Inherits="WinEr.BookIssueReport" %>
       ...
       <div class="container skin1"  >
        <table   cellpadding="0" cellspacing="0" class="containerTable">
            <tr >
                ...
                <td class="n">View Issue Bill Report</td>
                <td class="ne"> </td>
            </tr>
            <tr >
                <td class="o"> </td>
               ...
               <td align="left"><asp:DropDownList ID="Drp_Class" runat="server" Width="153px" class="form-control"
                       onselectedindexchanged="Drp_Class_SelectedIndexChanged" 
                       AutoPostBack="True">
               </asp:DropDownList></td>
                 <td align="right">Select Period</td>
               <td align="left">
                  <asp:DropDownList ID="Drp_Period" runat="server" Width="153px" class="form-control"
                      AutoPostBack="True" 
               ...
               <td align="left"><asp:TextBox ID="Txt_ToDate" runat="server" Width="150px" class="form-control"></asp:TextBox>
               ...
               <td align="left"><asp:DropDownList ID="Drp_Student" runat="server" Width="153px" class="form-control"
                       AutoPostBack="True" ></asp:DropDownList></td>
                       <td align="right"></td>
                       <td  align="left"><asp:Button ID="Btn_Show" runat="server" Text="Show" class="btn btn-primary" onclick="Btn_Show_Click" ValidationGroup="Show"
                       ></asp:Button></td>
              <%-- <td align="right">Select Item</td>
               ...
               <tr><td colspan="4" align="center"><asp:Label ID="Lbl_Err" runat="server" ForeColor="Red"></asp:Label></td></tr>
               </table> 
                 </center>
               </asp:Panel> 
            ...
            <%--    onpageindexchanging="Grd_Items_PageIndexChanging"--%>
                ...
                <tr>
                <td>
                            <asp:GridView ID="Grd_IssueReport" runat="server" 
                     ...
                     CellPadding="3" CellSpacing="2" Font-Size="15px"  AllowPaging="True"  AllowSorting="true"
                      PageSize="10"   Width="100%" 
                                onselectedindexchanged="Grd_IssueReport_SelectedIndexChanged" 
                                onpageindexchanging="Grd_IssueReport_PageIndexChanging" 
                              >
                   ...
                   <Columns>
                      ...
                      <asp:CommandField ItemStyle-Width="35" HeaderText="View Receipt" HeaderStyle-HorizontalAlign="Center" ControlStyle-Width="100px"
                       ItemStyle-Font-Bold="true" ItemStyle-Font-Size="Smaller"  ItemStyle-HorizontalAlign="Center"
                       SelectText="&lt;img src='Pics/Receipt.png' width='40px' border=0 title='Select to View'&gt;"
