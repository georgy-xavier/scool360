<%@ Page Title="" Language="C#" MasterPageFile="~/WinErStudentMaster.master" AutoEventWireup="true" CodeBehind="ClassAttdYearReport.aspx.cs" Inherits="WinEr.ClassAttdYearReport" %>
  ...
  <ContentTemplate>
   ...
   <div class="container skin1" >
        <table   cellpadding="0" cellspacing="0" class="containerTable">
          <tr >
            <td class="no"> </td>
            <td class="n">Yearly Attendance Report</td>
            <td class="ne"> </td>
          </tr>
          <tr >
             <td class="o"> </td>
                ...
                <table width="100%" cellspacing="10">
                  <tr>
                    ...
                    <td align="left" style="width:25%">
                       <asp:DropDownList ID="Drp_ClassSelect" runat="server" class="form-control" Width="170px">
                         </asp:DropDownList>
                    </td>
