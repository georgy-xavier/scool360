<%@ Page Language="C#" MasterPageFile="~/WinErStudentMaster.master" AutoEventWireup="true" Inherits="Enterfailedstudmark"  Codebehind="Enterfailedstudmark.aspx.cs" %>
		...
		<table class="style1" >
			...
			<tr>
				...
				<td >
                    ...
                    <asp:TextBox ID="Txt_failmarkCol" runat="server" Visible="False" class="form-control"></asp:TextBox>
				</td>
				<td>
					&nbsp;</td>
			</tr>
