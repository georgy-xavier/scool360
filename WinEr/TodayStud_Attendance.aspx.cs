...
namespace WinEr
{
    public partial class TodayStud_Attendance : System.Web.UI.Page
    {
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this.pnlAjaxUpdaet, this.pnlAjaxUpdaet.GetType(), "AnyScriptNameYouLike", "window.open(\"PrintTodaysAttd.aspx\");", true);
        }
    }
}
