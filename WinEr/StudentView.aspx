<%@ Page Language="C#" MasterPageFile="WinErStudentMaster.master" AutoEventWireup="true" CodeBehind="StudentView.aspx.cs" Inherits="WinEr.StudentView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
	...
	<div class="container-fluid card0">
		...
		<div class="well text-center card0" style="margin:  0;padding: 10px;background-color: white;border-bottom: 0;">
			...
			<span style="padding:0 20px 0 20px;"><a href="StudentView.aspx"><i class="fa fa-refresh"  style="color:green;"></i></a></span>
	...
	<script>
		...
		var createTable = {
			OnLiveStudent: function (response, studentType) {
				...
				$('#studentTable2_wrapper,#studentTable3_wrapper').hide();
				loaddtTableSettings();
			...
			OnHistoryStudent: function (response, studentType) {
				...
				$('#studentTable1_wrapper,#studentTable3_wrapper').hide();
				loaddtTableSettings();
			...
			OnTempStudent: function (response, studentType) {
				...
				$('#studentTable1_wrapper,#studentTable2_wrapper').hide();
				loaddtTableSettings();
