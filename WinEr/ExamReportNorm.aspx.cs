...
namespace WinEr
{
    public partial class ExamReportNorm : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!MyUser.HaveActionRignt(3029))
            {
                Response.Redirect("RoleErr.htm");
            }
            else
        ...
        protected void Btn_IndiGenerate_Click(object sender, EventArgs e)
        {
            ...
            if (MyPdf.CreateNormalExamReportPdf(_ClassId, _ExamId, _PeriodId, MyUser.CurrentBatchId, MyUser.CurrentBatchName, _physicalpath, out _PdfName, out _ErrorMsg))
            {
                _ErrorMsg = "";
