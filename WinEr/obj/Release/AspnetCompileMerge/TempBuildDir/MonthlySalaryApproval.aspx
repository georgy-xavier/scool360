<%@ Page Title="" Language="C#" MasterPageFile="~/WinerSchoolMaster.Master" AutoEventWireup="true" CodeBehind="MonthlySalaryApproval.aspx.cs" Inherits="WinEr.MonthlySalaryApproval" %>
...
<div class="container skin1">
  <table   cellpadding="0" cellspacing="0" class="containerTable">
            <tr >
                ...
                <td class="n">MONTHLY SALARY APPROVAL</td>
                <td class="ne"> </td>
            </tr>
            <tr >
                <td class="o"> </td>
                ...
                <td class="leftside">
                   <asp:DropDownList ID="DrpYear" runat="server" Width="85px" AutoPostBack="true" class="form-control"
                    ...
                    <asp:DropDownList ID="Drp_Month" runat="server" Width="140px" class="form-control"
                        AutoPostBack="True" onselectedindexchanged="Drp_Month_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
                ...
                <td class="rightside">
                 ...
                 <asp:Button ID="BtnApprove" runat="server" Text="Approve" Class="btn btn-success" 
                   ...
                   CellPadding="3" CellSpacing="2" Font-Size="12px" onselectedindexchanged="Grd_EmpPay_Selectedindexchanged"> <%--onselectedindexchanged="Grd_EmpPay_Selectedindexchanged"
                     ...
                     OnRowDeleting="Grd_Cat_RowDeleting"--%>
                        ...
                        <asp:BoundField DataField="Id"  HeaderText="Id" ItemStyle-Width="40px" />
                           <asp:TemplateField HeaderText="Paroll" ItemStyle-Width="40px">
                    <ItemTemplate>
                    ...
                    <HeaderTemplate > 
                        ...
                        <asp:BoundField DataField="AdvSal"  HeaderText="Adv.Salary Deduction" ItemStyle-Width="100px" />
  ...
  <asp:Button runat="server" ID="hdnButton3" style="display:none"/>
  <ajaxToolkit:ModalPopupExtender ID="MPE_EditComment_popup" 
                                  runat="server"  PopupControlID="Panel_comment" TargetControlID="hdnButton3" CancelControlID="Btn_Add_Cancel" BackgroundCssClass="modalBackground" />
   <asp:Panel ID="Panel_comment" runat="server"  DefaultButton="Btn_CommentSave" style="display:none;" >   <%--style="display:none;" --%>                      
               ...
               <center>
                  <table cellspacing="10">
                   ...
                   <tr>
                     ...
                     <td align="left">
                     <asp:Button ID="Btn_CommentSave" runat="server" Text="Save" Class="btn btn-success" 
