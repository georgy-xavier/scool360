<%@ Page Language="C#" MasterPageFile="WinErStudentMaster.master" AutoEventWireup="true" Inherits="WinSchoolHome" Title="Winschool Home" CodeBehind="WinSchoolHome.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
	...
	<script type="text/javascript">
	    $(document).ready(function () {
			$("#StudentDiv,#StaffDiv,#HomeInfo").html(circleLoader);
			...
			loadInstDt();//load from common method
			winSchoolHome_aspx.loadDt();
			//if (localStorage.getItem("$UPDATE$") !== "1") {
			//    iziToast.show({
			//        title: 'New Updates available ( v5.0.0 )',
			//        message: 'Press " ctrl + f5 " Keys & reload browser before use',
			//        position: 'topLeft', theme: 'dark', timeout: 15000, transitionIn: 'fadeIn'
			//    });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
	...
	<asp:Panel runat="server" Width="100%" ID="Panel2" HorizontalAlign="Center">
			<div class="customContainer">
				<div id="HomeschName" class="customContainer card0">
					...
					<div class="col-lg-8">
						...
						<div class="row">
							<hr>
							<h4 style="color: #9E9E9E;font-weight: 100;">Student Manager Dashboard</h4>
						</div>
					</div>
					<div class="col-lg-2">
			...
			<div class="row customContainer">
				<div class="col-xs-12 col-sm-6 col-md-3">
					<div class="card0" style="border-radius:0;padding:10px;padding-top: 10px;min-height:350px;max-height:350px;margin-top: 20px;">
					...
					<div class="col-xs-12 col-sm-6 col-md-6">
						<div id="sliderCard" class="card0" style="border-radius:0;padding:10px;padding-top:10px;min-height:350px;max-height:350px;margin-top: 20px;">
					...
					<div class="col-xs-12 col-sm-6 col-md-3">
						<div id="birthDCard" class="card0" style="border-radius:0;padding:2px;padding-top:10px;min-height:350px;max-height:350px;margin-top: 20px;">
											...
											<tr>
												<td colspan="3" align="left">
													<ajaxToolkit:TabContainer runat="server" ID="Tabs" Width="100%"
														...
														<ajaxToolkit:TabPanel runat="server" ID="TabPanel1" HeaderText="Student" Width="50%">
															<HeaderTemplate>
																<div id="studHead"  style="font-size: 20px;margin-bottom: -20px;width:120px;">
																	<i id="studHd" class="fa fa-graduation-cap"></i><span><p>Students Birthday</p></span>
																</div>
															</HeaderTemplate>
															<ContentTemplate>
														...
														<ajaxToolkit:TabPanel runat="server" ID="TabPanel2" HeaderText="Staff" Visible="true" Width="50%">
															<HeaderTemplate>
