<%@ Page Title="" Language="C#" MasterPageFile="~/WinErStudentMaster.master" AutoEventWireup="true" CodeBehind="EvaluationRecordCard.aspx.cs" Inherits="WinEr.EvaluationRecordCard" %>
            ...
            <ContentTemplate>
                <div class="container skin1" >
		            <table cellpadding="0" cellspacing="0" class="containerTable">
			            <tr >
				            <td class="no"> </td>
				            <td class="n">School Evaluation Record Card</td>
				            <td class="ne"> </td>
			            </tr>
			            <tr>
				            <td class="o"></td>
                     ...
                     <td class="rightside"><br /></td>
                                            ...
                                            <tr>
                                                ...
                                                <td  align="left"><asp:TextBox ID="Txt_ReportName" runat="server" Width="200px" class="form-control" Text="SCHOOL EVALUATION RECORD CARD"></asp:TextBox></td>
                                            </tr>
                                          <tr>
                     <td class="leftside"><br /></td>
                     <td class="rightside"><br /></td>
