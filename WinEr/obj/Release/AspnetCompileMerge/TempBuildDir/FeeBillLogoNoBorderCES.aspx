<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="FeeBillLogoNoBorderCES.aspx.cs" Inherits="WinEr.FeeBillLogoNoBorderCES" %>
                ...
                <div style="">
                    ...
                    <asp:Panel ID="Panel1" runat="server" >
                        ...
                        <table  width="100%">
                            <tr>
                                <td align="left" >
                                    <asp:Label ID="LblStudName" runat="server" Text="Student's Name" Font-Bold="True"></asp:Label>
                                </td>
                                <td align="left" >
                            ...
                            <tr>
                                ...
                                <td align="left" class="style10" >
                                    <asp:Label ID="lblClass" runat="server" Text="Class & Sec " Font-Bold="True"></asp:Label>
                                </td>
                                <td align="left" class="style10">
                            ...
                            <td align="left" class="style5">
                                    <asp:Label ID="Lbl_Staff" runat="server" Text="Collected By" Font-Bold="True"></asp:Label>
                                </td>
                           ...
                           <tr>
                                <td  align="left">
                                        <asp:Label ID="Lbl_BankName" runat="server" Text="Bank Name" Font-Bold="True"></asp:Label>
                                </td>
                                <td  align="left">
...
<br /><br />
<div style="float:right;padding-right:10%;">Accountant  Sign</div>
            </div>
           </td>
        </tr>
    </table>
