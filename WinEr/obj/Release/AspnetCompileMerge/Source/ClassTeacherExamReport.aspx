<%@ Page Title="" Language="C#" MasterPageFile="~/WinErStudentMaster.master" AutoEventWireup="true" CodeBehind="ClassTeacherExamReport.aspx.cs" Inherits="WinEr.ClassTeacherExamReport" %>
...
<div id="contents">
 <div class="container skin1" style="max-width:800px">
        <table   cellpadding="0" cellspacing="0" class="containerTable">
            <tr >
                <td class="no"> </td>
                <td class="n">Class Teacher Report</td>
                <td class="ne"> </td>
            </tr>
            <tr>
                <td class="o" > </td>
        ...
        <center>
                ...
                <td> <br /></td>
                   ...
                   <div id="ClassTeacherReport" runat="server" >
                   </div>
                     <br />
