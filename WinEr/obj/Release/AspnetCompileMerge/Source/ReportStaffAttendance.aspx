<%@ Page Language="C#" MasterPageFile="~/WinErStudentMaster.master" AutoEventWireup="true" CodeBehind="ReportStaffAttendance.aspx.cs" Inherits="WinEr.ReportStaffAttendance"  %>
...
<div id="ActionInfo" runat="server">
      ...
      <asp:Panel ID="dailyGrid" runat="server"> 
        ...
        <table   cellpadding="0" cellspacing="0" class="containerTable">
            <tr >
                <td class="no"> </td>
                <td class="n"> Staff Attendance Register</td>
                <td class="ne"> </td>
            </tr>
            <tr>
                <td class="o"> </td>
                   ...
                   <table>
                      <tr>
                        <td style="width:100px">Select the Mode:</td> 
                         <td> <asp:DropDownList ID="Drp_selectdays" runat="server" Width="163px" AutoPostBack="True" OnSelectedIndexChanged="selectDifferMode">
                         </asp:DropDownList  ></td>
                         <td style="width:30px"></td><td>
                             <asp:Button ID="Btn_UpdateAttandance" runat="server" Text="Save" 
                                 onclick="Btn_UpdateAttandance_Click" /></td>
                                 <td style="width:30px">
                                 </td>
                          <td>
                            <asp:Button ID="btn_Edit" runat="server" Text="Update" 
                                 onclick="Btn_EditAttandance_Click" />
                         ...
                         <asp:Panel ID="Pnl_Daily" runat="server">
                          &nbsp;&nbsp;<asp:Calendar ID="Cal_DateEntry" runat="server" BackColor="White" 
                              ...
                              NextPrevFormat="ShortMonth" onselectionchanged="Calendar1_SelectionChanged" 
                                 ondayrender="Cal_DateEntry_DayRender" 
                                 onvisiblemonthchanged="Cal_DateEntry_VisibleMonthChanged" >
                      ...
                      <asp:Panel ID="Pnl_Weekly"  runat="server">  
                        <table width="100%">
                          <tr>
                             ...
                             <td style="width:120px"><asp:TextBox ID="Txt_statrDate" runat="server" Width="160px" AutoPostBack="True" ontextchanged="Txt_statrDate_TextChanged"  ></asp:TextBox></td> 
                             <td>  <asp:Label ID="Lbl_from" runat="server" Text="      From: "></asp:Label><asp:Label ID="Lbl_startDate" runat="server" Text="" ForeColor="Red"></asp:Label> <asp:Label ID="Lbl_to" runat="server" Text="  To:  "></asp:Label><asp:Label ID="Lbl_EndDate" runat="server" Text="" ForeColor="Red"></asp:Label></td>
                          </tr>
                       </table><ajaxToolkit:CalendarExtender ID="Txt_statrDate_CalendarExtender" 
