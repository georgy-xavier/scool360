<%@ Page Title="" Language="C#" MasterPageFile="~/WinerSchoolMaster.Master" AutoEventWireup="true" CodeBehind="InventoryMoveItems.aspx.cs" Inherits="WinEr.InventoryMoveItems" %>
...
<asp:UpdatePanel ID="pnlAjaxUpdaet" runat="server">
    ...
    <div class="container skin1" >
		<table cellpadding="0" cellspacing="0" class="containerTable">
			<tr >
				<td class="no"> </td>
				<td class="n"><table width="100%"><tr><td align="left">Move Items </td>
				<td align="right" style="font-size:14px">
				<div class="form-inline">	From Location 
                    <asp:DropDownList ID="drp_location" class="form-control" runat="server" Width="150px" 
                        onselectedindexchanged="drp_location_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>&nbsp;&nbsp;|&nbsp;&nbsp;  To Location
				        <asp:DropDownList ID="Drp_ToLocation" 
				runat="server" class="form-control"
                        Width="160px" ></asp:DropDownList></td></tr></table>
				</td>
				<td class="ne" >
				</div></td>
			</tr>
				    ...
				    <table width="100%">
				        ...
				        <td valign="top"> 
                            ...
                            <table class="tablelist" width="100%">
                              ...
                              <tr>
				        <td class="leftside">
				            Date</td><td  class="rightside"><asp:TextBox ID="Txt_MoveDate" class="form-control" runat="server" Width="150px" ></asp:TextBox>
                            <cc1:MaskedEditExtender ID="Txt_SaleDate_MaskedEditExtender" runat="server" Enabled="True" TargetControlID="Txt_MoveDate"
                            ...
                            ControlToValidate="Txt_MoveDate" ValidationGroup="sale"  Display="None"
                            ...
                            ControlToValidate="Txt_MoveDate" ErrorMessage="Enter Date"></asp:RequiredFieldValidator>
                        </td>
                        </tr>
                        <tr>
                     ...
                     <td class="rightside"><br /></td>
                        ...
                        <tr>
				        <td  class="leftside">    Description </td><td  class="rightside"><asp:TextBox ID="txt_moveDescription" class="form-control" runat="server" Text =""  TextMode="MultiLine" Width="200px" MaxLength="250"> </asp:TextBox>
        ...
        <asp:Panel ID="pnl_ItemArea" runat="server">
				...
				<asp:GridView ID="Grd_Moveitem" runat="server" AutoGenerateColumns="false" BackColor="#EBEBEB"
                     ...
                     CellPadding="3" CellSpacing="2" Font-Size="15px"  AllowPaging="True" AllowSorting="true"
                      ...
                      onselectedindexchanged="Grd_Grd_Moveitem_SelectedIndexChanged" >
               <FooterStyle BackColor="#bfbfbf" ForeColor="Black" />
				...
				<table width="100%">
				 <tr>
				        <td align="center">
				            <asp:Button ID="Btn_Move" runat="server" Text="Move" 
                        class="btn btn-success" ValidationGroup="sale"
                                 onclick="Btn_move_Click" />
            <asp:Button ID="Btn_saleCancel" runat="server" Text="Cancel" class="btn btn-danger" onclick="Btn_Cancel_Click" /></td></tr>
