<%@ Page Title="" Language="C#" MasterPageFile="~/WinErStudentMaster.master" AutoEventWireup="True" CodeBehind="ParentLoginReport.aspx.cs" Inherits="WinEr.ParentLoginReport" %>
...
<asp:ListItem Text="LogIn Recently" Value="1"></asp:ListItem>
<asp:ListItem Text="Not LogIn Yet" Value="2"></asp:ListItem>
...
<asp:BoundField DataField="Last Login"  HeaderText="Last LogIn" ItemStyle-Width="100px" />                        
</Columns>
