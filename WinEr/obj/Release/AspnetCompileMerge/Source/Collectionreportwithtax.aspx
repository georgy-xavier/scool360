<%@ Page Title="" Language="C#" MasterPageFile="~/WinErStudentMaster.master" AutoEventWireup="true" CodeBehind="Collectionreportwithtax.aspx.cs" Inherits="WinEr.Collectionreportwithtax" %>
            ...
            <ContentTemplate>
                ...
                <div class="container skin1">
                    <table cellpadding="0" cellspacing="0" class="containerTable">
                        <tr>
                            <td class="no"></td>
                            <td class="n">Fee Transactions with Tax</td>
                            <td class="ne"></td>
                        </tr>
                        <tr>
                            <td class="o"></td>
...
&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Btn_ExportAmount" runat="server" Enabled="False" Class="btn btn-primary"   OnClick="Btn_Exportamount" Text="Excel Export"  ></asp:Button>&nbsp;&nbsp;&nbsp;
