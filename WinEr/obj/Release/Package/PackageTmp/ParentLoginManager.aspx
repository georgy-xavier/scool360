<%@ Page Title="" Language="C#" MasterPageFile="~/WinErStudentMaster.master" AutoEventWireup="True" CodeBehind="ParentLoginManager.aspx.cs" Inherits="WinEr.ParentLoginManager" %>
...
<asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="pnlAjaxUpdaet">
        ...
        <table   cellpadding="0" cellspacing="0" class="containerTable">
            <tr >
                <td class="no"> </td>
                <td class="n">Parent Login Management</td>
                <td class="ne"> </td>
            </tr>
            <tr >
                <td class="o"> </td>
                ...
                <table width="90%">
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="Btn_Advanced" runat="server" Text="ENABLE/DISABLE"  Class="btn btn-primary"/>
                        </td>
                    </tr>
                </table>
                </center>
         ...
         <%--       <asp:Panel ID="Pnl_SMS" runat="server" Visible="false">
                ...
                <asp:GridView ID="Grd_ParentList" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                         ...
                         <asp:BoundField DataField="GardianName" HeaderText="ParentName"  ItemStyle-Width="120"/>
            ...
            <asp:Panel ID="Panel4" runat="server"  Style="display: none;" >
                <div class="container skin5" style="width:600px;" >
                            ...
                            <table class="tablelist">
                                 ...
                                 <tr >
                                   ...
                                   <tr>
                                    ...
                                    <asp:RequiredFieldValidator ID="Txt_USerId_Req" runat="server" ErrorMessage="Enter UserId/MobNo" ControlToValidate="Txt_USerId" ValidationGroup="Saveme"></asp:RequiredFieldValidator>
                                    
                                    </td>
                                      <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" 
                                     runat="server" Enabled="True"  FilterType="Custom,Numbers" 
                                     ValidChars="+"   TargetControlID="Txt_USerId">
                  ...
                  <asp:Panel ID="Pnl_Advanced" runat="server">
                     <ajaxToolkit:ModalPopupExtender ID="MPE_AdvanceOption" runat="server" CancelControlID="Btn_Ok"
                      PopupControlID="Panel5" TargetControlID="Btn_Advanced" BackgroundCssClass="modalBackground" />
                       <asp:Panel ID="Panel5" runat="server" style="display:none;">
                             <div class="container skin5" style="width:300px">
        <table   cellpadding="0" cellspacing="0" class="containerTable">
            <tr >
                <td class="no"><asp:Image ID="Image5" runat="server" ImageUrl="~/Pics/configure1.png" Height="28px"  Width="29px" /> </td>
                <td class="n"><span style="color:White;">Advanced</span> </td>
                <td class="ne"> </td>
            </tr>
            <tr >
                <td class="o"> </td>
                <td class="c" >
                                 ...
                                 <center>
                                     <table class="tablelist">
                                        <tr>
                                            <td>
                                                <asp:CheckBox ID="Chk_ActivateParentLogin" runat="server" AutoPostBack="true" OnCheckedChanged="Chk_ActivateParentLogin_Cheked"  Text="Enable Parent Login"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="Lbl_EnableLogin" runat="server" class="control-label" ForeColor="Blue"></asp:Label>
                                            </td>
                                        </tr>
                                         <tr>
                                            <td>
                                                <asp:Button ID="Btn_Ok" runat="server" Text="Ok"  Width="80px" class="btn btn-info"/>
                                            </td>
                                        </tr>
