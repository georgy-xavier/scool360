<%@ Page Title="" Language="C#" MasterPageFile="~/WinErStudentMaster.master" AutoEventWireup="true" CodeBehind="ClassExamReport.aspx.cs" Inherits="WinEr.ClassExamReport" %>
				...
				<td class="c" >
                                            ...
                                            <br />
                                                <table class="tablelist">
                                                  <tr>
                                                        ...
                                                        <td class="rightside"><asp:DropDownList ID="Drp_ClassSelect" runat="server" AutoPostBack="True" class="form-control"
                                                                Width="160px" onselectedindexchanged="Drp_ClassSelect_SelectedIndexChanged">
                     ...
                     <td class="rightside"><br /></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="rightside"><asp:DropDownList ID="Drp_ExamType" runat="server" AutoPostBack="True" class="form-control"
                                                                Width="160px" onselectedindexchanged="Drp_ExamType_SelectedIndexChanged"
                                                                 >
                                                            </asp:DropDownList></td></tr>
                                                            <tr>
                     <td class="leftside"><br /></td>
                     <td class="rightside"><br /></td>
                                                        ...
                                                        <td class="rightside">
                                                            <asp:DropDownList ID="Drp_Exam" runat="server" AutoPostBack="True" class="form-control"
                                                                Width="160px" onselectedindexchanged="Drp_Exam_SelectedIndexChanged"
                                                                >
                                                            </asp:DropDownList>
                                                        </td></tr>
                                                        <tr>
