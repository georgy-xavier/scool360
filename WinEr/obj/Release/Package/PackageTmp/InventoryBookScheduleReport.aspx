<%@ Page Title="" Language="C#" MasterPageFile="~/WinerSchoolMaster.Master" AutoEventWireup="true" CodeBehind="InventoryBookScheduleReport.aspx.cs" Inherits="WinEr.InventoryBookScheduleReport" %>
       ...
       <div class="container skin1"  >
        <table   cellpadding="0" cellspacing="0" class="containerTable">
            <tr >
                ...
                <td class="n">Item Non-Issue Report</td>
                <td class="ne"> </td>
            </tr>
            <tr >
                <td class="o"> </td>
               ...
               <td></td>
               <td></td>
               <td><asp:Button ID="Btn_Show" runat="server" Text="Show" class="btn btn-primary"
                       onclick="Btn_Show_Click" ValidationGroup="Show"></asp:Button></td>
               </tr>
            ...
            <%--    onpageindexchanging="Grd_Items_PageIndexChanging"--%>
                ...
                <tr>
                <td>
                            <asp:GridView ID="Grd_ScheduleBookReport" runat="server" 
                     ...
                     CellPadding="3" CellSpacing="2" Font-Size="15px"  AllowPaging="True"  AllowSorting="true"
                      PageSize="10"   Width="100%" 
                                onpageindexchanging="Grd_ScheduleBookReport_PageIndexChanging" >
