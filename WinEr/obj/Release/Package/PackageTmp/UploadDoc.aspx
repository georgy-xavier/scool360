<%@ Page Title="" Language="C#" MasterPageFile="~/WinErStudentMaster.master" AutoEventWireup="true" CodeBehind="UploadDoc.aspx.cs" Inherits="WinEr.UploadDoc" %>
    ...
    <asp:UpdateProgress ID="UpdateProgress2" runat="server" AssociatedUpdatePanelID="pnlAjaxUpdaet"><ProgressTemplate>                               
     ...
     <asp:UpdatePanel ID="pnlAjaxUpdaet" runat="server">
        <ContentTemplate>
                    ...
                    <tr>
                        ...
                        <td class="c">
                            <div align="center">
                                <table width="100%">
                                    <tr>
                                        <td  align="right">Select Doc Type</td>
                                        <td  align="left">
                                            
                                          <asp:DropDownList ID="Drp_Doctype" runat="server" class="form-control" Width="200px">
                                              </asp:DropDownList>
                                        </td>
                                    </tr>
                     ...
                     <td class="rightside"><br /></td>
                                     ...
                                     <tr>
                                        <td></td>
                                        <td  align="left"><asp:Button ID="Btn_UploadDoc" runat="server" Text="Upload Document" class="btn btn-primary" OnClick="Btn_UploadDoc_Click"/></td>
                                    </tr>
                                     <tr>
         ...
         <Triggers><asp:PostBackTrigger ControlID="Btn_UploadDoc" />
