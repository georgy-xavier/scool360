...
namespace WinEr
{
    public partial class FeeBillLogoNoBorderCES : System.Web.UI.Page
    {
            ...
            else
            {
                ...
                else
                {
                    if (!IsPostBack)
                    {
                        ...
                        Lbl_StaffName.Text = MyFeeMang.LoadFeeCollectedStaffNameWithDesignation(BillNo, BillType);
                        LoadSchoolDetails();
                    }
                }
            }
        ...
        private void LoadTotal(string BillNo, string BillType)
        {
            ...
            if (MyReader.HasRows)
            {
                LblAmt.Text = "Rs:" + MyReader.GetValue(0).ToString()+".00";
            ...
            if (data_Fee != null && data_Fee.Tables != null && data_Fee.Tables[0].Rows.Count > 0)
            {
                foreach (DataRow dr in data_Fee.Tables[0].Rows)
                {
                    ...
                    if (_Period == "" && _FeeName == "" && _Batch == "")
                    {
                        ...
                        table = table + "<tr><td class=\"tdStyle\"> &nbsp;" + _Batch + "&nbsp; </td><td class=\"tdStyle\"> &nbsp;" + _Period + "&nbsp; </td><td class=\"tdStyle\">" + _FeeName + "-" + dr[2].ToString() + "</td><td class=\"tdStyle\"> Rs: " + dr[3].ToString() + ".00</td></tr>";//<td class=\"tdStyle\">" + dr[2].ToString() + "</td>
                    ...
                    {
                        table = table + "<tr><td class=\"tdStyle\"> &nbsp;&nbsp;&nbsp;&nbsp; </td><td class=\"tdStyle\"> &nbsp;&nbsp;&nbsp;&nbsp; </td><td class=\"tdStyle\">" + dr[1].ToString() + "-" + dr[2].ToString() + "</td><td class=\"tdStyle\">Rs: " + dr[3].ToString() + ".00</td></tr>";//<td class=\"tdStyle\">" + dr[2].ToString() + "</td>
                        if ("Discount" != dr[2].ToString())
                        {
