...
public partial class FailedStudentReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                string _ExamMenuStr;
                _ExamMenuStr = MyExamMang.GetFailExamMangMenuString(MyUser.UserRoleId);
    ...
    protected void lnk_supplimentaryreport_Click(object sender, EventArgs e)
    {
        Response.Redirect("SupplimentaryReport.aspx");
    }
    ...
    private void GenerateAllStudReport()
    {
        ...
        foreach (GridViewRow gv in Grd_CreateReport.Rows)
        {
            ...
            if (MyReader.HasRows)
            {
                ...
                MyExamMang.UpdateResultFail(int.Parse(gv.Cells[0].Text.ToString()), _scheduledid, _Max_Total, _Total, _Sub_Count, _Result, ds_aggre, _scheduledid, _Examid, _classid, MyUser.CurrentBatchId, _examperiod);
    ...
    protected void Btn_Gen_Click(object sender, EventArgs e)
    {
        ...
        LoadResult();
        Btn_supplimentaryreport.Visible = true;
