...
public class ConfigManager : KnowinGen
{
    ...
    public string getHomeInfo(int _Mode, int _RoleId, int _BatchId, int UserId)
    {
        ...
        int ActionId = 0, mode = 0, cnt = 1, actNum = 0;
         ...
         {
             _HomeDetailString.Append("<div class=\"row customContainer\">");

             while (m_MyReaderHead.Read())
             {
                 ActionId = int.Parse(m_MyReaderHead.GetValue(0).ToString());
                 actNum = m_MyReaderHead.RecordsAffected;
                 content = GetInfo(ActionId, mode, _BatchId, UserId, actNum);
                 heading = m_MyReaderHead.GetValue(1).ToString();
                 _HomeDetailString.Append(UseBox(content, heading, style));
                 if (cnt % 3 == 0)
                 {
                     _HomeDetailString.Append("</div><div>");
                 }
                 cnt++;
             }
             cnt--;
             if (cnt % 3 != 0)
             {
                 ...
                 {
                     RemaingTds = RemaingTds + "<div><div style=\"width:30%;\"></div></div>";
                 }
                 _HomeDetailString.Append(RemaingTds);
             }
             _HomeDetailString.Append("</div>");
         }
         m_MyReaderHead.Close();
         return _HomeDetailString.ToString();
    }
    private string GetInfo(int ActionId, int mode, int _BatchId, int UserId, int actNum)
    {
        string content = "";
        
        if (ActionId == 420)
        {
            content = getStudTableInfo(_BatchId, actNum);
        }
        ...
        {
            content = getStaffTableInfo(ActionId, actNum);
        }
        else if (ActionId == 428)
        {
            content = getClassTableInfo(ActionId, _BatchId, actNum);
        }
        
        return content;
    }

    private string getStudTableInfo(int _BatchId, int actNum)
    {
        string main = "col-lg-6 col-md-6 col-xs-12",sub = "col-lg-6 col-md-6 col-xs-12";
        if (actNum % 2 == 0)
        {
            main = "col-lg-12 col-md-12 col-xs-12"; sub = "col-lg-4 col-md-4 col-xs-12";
        }
        ...
        string sql = "";
        m_MyReader = null;
        _StudentTable.Append("<div class=\"" + main + " homInfoCard\"><div class=\"card0\" style=\"background-color:white;\">");
        ...
        _StudentTable.Append("<div style=\"border-bottom:1px solid #dedcdc;\"><div class=\"row\"><div class=\"col-xs-6 text-right\"><div style=\"font-size:25px;color:#6f6f6f;margin-top:15px;font-weight:300;\">Total Students</div></div>");
        _StudentTable.Append("<div class=\"col-xs-6\"><div style=\"font-size:45px;color:#6f6f6f;font-weight:500;\">" + total + "</div></div></div></div>");
        _StudentTable.Append("<div class=\"cutomPanelBody scrollStyle scrollbar force-overflow\">");
        ...
        Percent = ((double)boys / (double)total) * 100.0;
        _StudentTable.Append("<div class=\"" + sub + "\"><div class=\"panel customPanel\"><div class=\"panel-heading customPanelHd\" style=\"min-height:135px;\"><div class=\"row\" style=\"color:#848484;\"><div class=\"col-xs-12 text-center\">");
        _StudentTable.Append("<div style=\"font-size:40px;font-weight:500;\">" + boys + "</div><div style=\"font-size:19px;font-weight:100;\">Boys</div>  </div></div></div></div></div>");
        m_MyReader = null; 
        ...
        Percent = ((double)girls / (double)total) * 100.0;
        _StudentTable.Append("<div class=\"" + sub + "\"><div class=\"panel customPanel\"><div class=\"panel-heading customPanelHd\" style=\"min-height:135px;\"><div class=\"row\" style=\"color:#848484;\"><div class=\"col-xs-12 text-center\">");
        _StudentTable.Append("<div style=\"font-size:40px;font-weight:500;\">" + girls + "</div><div style=\"font-size:19px;font-weight:100;\">Girls</div> </div></div></div></div></div>");
        m_MyReader = null;
        ...
        _StudentTable.Append("<div class=\"" + sub + "\"><div class=\"panel customPanel\"><div class=\"panel-heading customPanelHd\" style=\"min-height:135px;\"><div class=\"row\" style=\"color:#848484;\"><div class=\"col-xs-12 text-center\">");
        _StudentTable.Append("<div style=\"font-size:40px;font-weight:500;\">" + temp + "</div><div style=\"font-size:19px;font-weight:100;\">Registered Students</div></div></div></div></div></div>");
        ...
        _StudentTable.Append("<div class=\"" + sub + "\"><div class=\"panel customPanel\"><div class=\"panel-heading customPanelHd\" style=\"min-height:135px;\"><div class=\"row\" style=\"color:#848484;\"><div class=\"col-xs-12 text-center\">");
        _StudentTable.Append("<div style=\"font-size:40px;font-weight:500;\">" + pr_studs + "</div><div style=\"font-size:19px;font-weight:100;\">Students in Promotion List</div></div></div></div></div></div>");

        _StudentTable.Append("</div></div></div>");
    ...
    private string getTransportTableInfo()
    {
        ...
        string sql = "";
        _TransportTable.Append("<div class=\"col-md-6 col-xs-12 homInfoCard\"><div class=\"card0\" style=\"background-color:white;\">");
    ...
    private string getStaffTableInfo(int ActionId, int actNum)
    {
        string main = "col-lg-6 col-md-6 col-xs-12",sub = "col-lg-6 col-md-6 col-xs-6";
        if (actNum % 2 == 0)
        {
            main = "col-lg-12 col-md-12 xol-xs-12"; sub = "col-lg-4 col-md-4 col-xs-6";
        }
        ...
        _StaffTable.Append("<div class=\""+main+" homInfoCard\"><div class=\"card0\" style=\"background-color:white;\">");
        ...
        _StaffTable.Append("<div style=\"border-bottom:1px solid #dedcdc;\"><div class=\"row\"><div class=\"col-xs-6 text-right\"><div style=\"font-size:25px;color:#6f6f6f;margin-top:15px;font-weight:300;\">Total Staffs</div></div>");
        _StaffTable.Append("<div class=\"col-xs-6\"><div style=\"font-size:45px;color:#6f6f6f;font-weight:500;\">" + staffs + "</div></div></div></div>");
        _StaffTable.Append("<div class=\"cutomPanelBody scrollStyle scrollbar force-overflow\">");
        ...
        if (m_MyReader.HasRows)
        {
            while (m_MyReader.Read())
            {
                ...
                if (myreader1.HasRows)
                {
                    ...
                    {
                        _StaffTable.Append("<div class=\"" + sub + "\"><div class=\"panel customPanel\"><div class=\"panel-heading customPanelHd\" style=\"min-height:135px;\"><div class=\"row\" style=\"color:#848484;\"><div class=\"col-xs-12 text-center\">");
                        _StaffTable.Append("<div style=\"font-size:40px;font-weight:500;\">" + myreader1.GetValue(0).ToString() + "</div><div style=\"font-size:19px;font-weight:100;\">" + m_MyReader.GetValue(1).ToString() + "</div></div></div></div></div></div>");
                    }
                }
            }
        }
        ...
        _StaffTable.Append("</div></div></div>");
        return _StaffTable.ToString();
    
    }

    private string getClassTableInfo(int ActionId, int _BatchId, int actNum)
    {
        StringBuilder _ClassTable = new StringBuilder("");
        int classes = 0, students = 0;
        string sql = ""; int totalStdnt = 0;
        _ClassTable.Append("<div class=\"col-md-12 col-xs-12 homInfoCard\"><div class=\"card0\" style=\"background-color:white;\">");
        ...
        _ClassTable.Append("<div style=\"border-bottom:1px solid #dedcdc;\"><div class=\"row\"><div class=\"col-xs-6 text-right\"><div style=\"font-size:25px;color:#6f6f6f;margin-top:15px;font-weight:300;\">Total Classes</div></div>");
        _ClassTable.Append("<div class=\"col-xs-6\"><div style=\"font-size:45px;color:#6f6f6f;font-weight:500;\">" + classes + "</div></div></div></div>");
        _ClassTable.Append("<div class=\"cutomPanelBody scrollStyle scrollbar force-overflow\">");
        ...
        if (m_MyReader.HasRows)
        {
            while (m_MyReader.Read())
            {
                totalStdnt = int.Parse(m_MyReader.GetValue(0).ToString());
            }
        }
        ...
        if (m_MyReader.HasRows)
        {
            while (m_MyReader.Read())
            {
                ...
                if (myReader1.HasRows)
                {
                    int clsNo = int.Parse(myReader1.GetValue(0).ToString());
                    double Percent = ((double)clsNo / (double)totalStdnt) * 100.0;
                    _ClassTable.Append("<div class=\"col-lg-4 col-md-4 col-xs-6\"><div class=\"panel customPanel\"><div class=\"panel-heading customPanelHd\" style=\"min-height:135px;\"><div class=\"row\" style=\"color:#848484;\"><div class=\"col-xs-12 text-center\">");
                    _ClassTable.Append("<div style=\"font-size:40px;font-weight:500;\">" + clsNo + "</div><div style=\"font-size:19px;font-weight:100;\">" + m_MyReader.GetValue(1).ToString() + "</div> </div></div></div></div></div>");
                }
            }
        }

        _ClassTable.Append("</div></div></div>");
    ...
    private string UseBox(string _Content, string _Heading, string _Style)
    {
        ...
        _RoundBoxDetailString.Append(_Content);
   ...
   private void RecalculateSchDetails(ref double _advanceAmt, ref double _CanceladvanceAmt, ref double BalanceAmount, ref string _Status)
    ...
    public DataSet GetStudentList(string _ClassId)
    {
        string CanLogin = "0";
        string ParentId = "";
        string UserId = "0";
        ...
        // string sql = "select tblstudent.Id , tblstudent.StudentName ,  tblstudent.GardianName , tblstudent.OfficePhNo  from tblstudent  inner join tblsmsparentlist on tblsmsparentlist.Id=  tblstudent.Id where tblstudent.LastClassId=" + _ClassId + " and tblstudent.`Status`=1 and   tblsmsparentlist.Enabled=1 order by tblstudent.RollNo asc";
        string sql = "select tblstudent.Id , tblstudent.StudentName ,  tblstudent.AdmitionNo , tblstudent.OfficePhNo,Email  from tblstudent  where tblstudent.LastClassId=" + _ClassId + " and tblstudent.`Status`=1  order by tblstudent.RollNo asc";
        m_MyReader = m_MysqlDb.ExecuteQuery(sql);
        if (m_MyReader.HasRows)
        {
            while (m_MyReader.Read())
            {
                ...
                dr["StudId"] = m_MyReader.GetValue(0).ToString();
                dr["StudentName"] = m_MyReader.GetValue(1).ToString();
                dr["AdmissionNo"] = m_MyReader.GetValue(2).ToString();
                dr["EmailId"] = m_MyReader["Email"].ToString();

                int SiblingId = GetSiblingId(dr["StudId"].ToString());
                dr["SentCredentials"] = GetStudSendStatus(SiblingId, dr["StudId"].ToString(), out CanLogin, out ParentId, out UserId, out _lastlogin, out date, out emailId);
    ...
    private string GetStudSendStatus(int SiblingId, string StudentId, out string _CanLogin, out string _ParentId, out string _UserName, out string _lastlogin, out string date, out string emailId)
    {
        string Status = "0";
        _CanLogin = "0";
        _ParentId = "0";
        ...
        string sql = "select tblstudentlogin.Loginname , tblstudentlogin.Status , tblstudentlogin.Studentid ,tblstudentlogin.CanLogin from tblstudentlogin where tblstudentlogin.Studentid = "+ StudentId +"";
        MyTempreader = m_MysqlDb.ExecuteQuery(sql);
        if (MyTempreader.HasRows)
        {
            Status = MyTempreader.GetValue(1).ToString();
            _CanLogin = MyTempreader.GetValue(3).ToString();
            _ParentId = MyTempreader.GetValue(2).ToString();
            _UserName = MyTempreader.GetValue(0).ToString();
